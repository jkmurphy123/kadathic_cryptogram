    ...
    def solve(
        ...
        *,
        ...
        Args:
            ...
            known_plaintext: If the ciphertext was generated by the app,
                the known plaintext enables hint-based retry prompts
                that show the LLM which letters it got right.
        ...
        for attempt in range(1, self._max_retries + 1):
            ...
            elif known_plaintext is not None and last_candidate is not None:
                current_prompt = cipher.build_hint_prompt(
                    ciphertext, last_candidate, known_plaintext
                )
            else:
